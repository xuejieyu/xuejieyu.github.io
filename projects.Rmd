...
- Due to the spotfire licence limitation, only PDF version is showing here.
 ...
 [How to predict Boston house price with linear regression model and public information](Boston_House_Prediction_With_Linear_Regression.html)
 
- Used linear regression model to predict Boston house price.
- Implemented train-test-split for cross-validation. 
- Calculated MSE to compare the results of train vs test.
